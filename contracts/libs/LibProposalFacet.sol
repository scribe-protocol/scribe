...
library LibProposalFacet {
    ...
    */
    function getContributorCount(string memory _proposalId) internal view returns (uint256) {
        LibDiamondStorageProposals.DiamondStorageProposals storage ds = LibDiamondStorageProposals.diamondStorageProposals();
